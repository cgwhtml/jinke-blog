 ...
 * @Last Modified time: 2018-08-22 21:29:59
 */
...
const SWPrecacheWebpackPlugin = require("sw-precache-webpack-plugin"); //生成 service-worker 配置文件  妈的以前自己写...
...
module.exports = env => {
  ...
  const options = {
    ...
    output: {
      ...
      filename:
        mode === "development" ? "js/[name].js" : "js/[name].[chunkhash:8].js",
      chunkFilename:
        mode === "development" ? "js/[name].js" : "js/[name].[chunkhash:8].js",
      publicPath: mode === "development" ? `${host}:${dev_port}/` : "/"
    },
  ...
  options.plugins.push(
    ...
    new SWPrecacheWebpackPlugin({
      ...
      filename: "sw.js",
      minify: false,
      navigateFallback: host + "/index.html",
      staticFileGlobsIgnorePatterns: [/\.map$/, /manifest\.json$/],
      importScripts: [
          path.resolve(__dirname,"src/shared/libs/webpush-sw.js")
      ]
    })
  );
  return options;
